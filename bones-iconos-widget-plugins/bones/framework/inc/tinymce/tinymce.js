...
/*-----------------------------------------------------------------------------------*/
(function() {  
    tinymce.create('tinymce.plugins.minti_button', {  
        init : function(ed, url) {  
            ed.addButton('minti_button', {  
                title : 'Add a Button',  
    ...
    tinymce.PluginManager.add('minti_button', tinymce.plugins.minti_button);  
})();
    ...
    tinymce.create('tinymce.plugins.member', {  
        init : function(ed, url) {  
            ed.addButton('member', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[member name="John Doe" role="Web Developer" url="http://example.com" img="http://mintithemes.com/nopic.png" twitter="http://twitter.com" facebook="http://facebook.com" skype="http://skype.com" google="http://google.de" linkedin="http://linkedin.com" mail="hellominti@gmail.com"]Description[/member]');  
...
/*-----------------------------------------------------------------------------------*/
(function() {  
    tinymce.create('tinymce.plugins.minti_tooltip', {  
        init : function(ed, url) {  
            ed.addButton('minti_tooltip', {  
                title : 'Add Tooltip',  
    ...
    tinymce.PluginManager.add('minti_tooltip', tinymce.plugins.minti_tooltip);  
})();
